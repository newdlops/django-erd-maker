  ...
  private update(
    ...
    logger.info(
      [
        ...
        ...(layoutMetadata?.nodeOverlaps !== undefined ? [`nodeOverlaps=${layoutMetadata.nodeOverlaps}`] : []),
        ...(layoutMetadata?.edgeNodeIntersections !== undefined ? [`edgeNodeIntersections=${layoutMetadata.edgeNodeIntersections}`] : []),
        ...(layoutMetadata?.overlappingEdges !== undefined ? [`overlappingEdges=${layoutMetadata.overlappingEdges}`] : []),
