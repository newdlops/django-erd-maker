...
function decodeLayoutEngineMetadata(
  ...
  return {
    ...
    bundleBundleOverlaps: readOptionalNumber(metadata, "bundleBundleOverlaps", `${context}.engineMetadata`),
    ...
    carrierBundleEdgeIntersections: readOptionalNumber(metadata, "carrierBundleEdgeIntersections", `${context}.engineMetadata`),
    carrierBundleNodeOverlaps: readOptionalNumber(metadata, "carrierBundleNodeOverlaps", `${context}.engineMetadata`),
    carrierEdgeCrossings: readOptionalNumber(metadata, "carrierEdgeCrossings", `${context}.engineMetadata`),
    carrierEdgeNodeIntersections: readOptionalNumber(metadata, "carrierEdgeNodeIntersections", `${context}.engineMetadata`),
    carrierNodeOverlaps: readOptionalNumber(metadata, "carrierNodeOverlaps", `${context}.engineMetadata`),
    carrierRouteSegments: readOptionalNumber(metadata, "carrierRouteSegments", `${context}.engineMetadata`),
    carrierVisualCrossings: readOptionalNumber(metadata, "carrierVisualCrossings", `${context}.engineMetadata`),
    ...
    renderedEdgeCount: readOptionalNumber(metadata, "renderedEdgeCount", `${context}.engineMetadata`),
    ...
    semanticCarrierBundledRelationships: readOptionalNumber(metadata, "semanticCarrierBundledRelationships", `${context}.engineMetadata`),
    semanticCarrierDisconnectedRelationships: readOptionalNumber(metadata, "semanticCarrierDisconnectedRelationships", `${context}.engineMetadata`),
    semanticCarrierFallbackRelationships: readOptionalNumber(metadata, "semanticCarrierFallbackRelationships", `${context}.engineMetadata`),
    semanticCarrierMissingRelationships: readOptionalNumber(metadata, "semanticCarrierMissingRelationships", `${context}.engineMetadata`),
    semanticCarrierObstacleIntersections: readOptionalNumber(metadata, "semanticCarrierObstacleIntersections", `${context}.engineMetadata`),
    semanticCarrierRelationships: readOptionalNumber(metadata, "semanticCarrierRelationships", `${context}.engineMetadata`),
    semanticCarrierSegments: readOptionalNumber(metadata, "semanticCarrierSegments", `${context}.engineMetadata`),
    ...
    visualCrossingsScope: readOptionalString(metadata, "visualCrossingsScope", `${context}.engineMetadata`),
...
function decodeRoutedEdgePath(value: unknown, context: string): RoutedEdgePath {
  ...
  return {
    ...
    sourceModelId: readOptionalModelId(record, "sourceModelId", context),
    targetModelId: readOptionalModelId(record, "targetModelId", context),
  };
}
